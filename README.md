...
## Frontend
HTML 5, CSS 3, Sass, JavaScript, TypeScript, React, NextJS, PrimeReact, Angular, PrimeNG, HTMX
...
## Data Sciense
Business Intelligence (BI), Big Data, Python, R, Metabase, Apache Hadoop, Elasticsearch
